    ...
    <div className="flex flex-col py-4 px-8 text-center border-2 border-[#5666BE80] w-full h-auto rounded-3xl gap-4">
        ...
        <div className="flex items-start gap-2">
          ...
          <p className="text-start">
            ...
            <br></br>
            <span>
              Paciente presenta diarrea acuosa y frecuente (más de 3
              deposiciones líquidas al día) acompañada de dolor abdominal y
              calambres. Se observa fiebre de 38.5°C y signos de deshidratación
              moderada. Antecedente de uso reciente de antibióticos
              (clindamicina).
            </span>
          </p>
        </div>
