  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 py-4 px-2">
        ...
        <p className="text-white font-bold text-xl">Buscar Turnos médicos</p>
      </div>
      ...
      >
        <div className="gap-2.5 relative">
          <select
            ...
            className="border-[#B7B7B7] border rounded-full w-[230px] text-[#1D1D1D] placeholder-[#1D1D1D] placeholder:text-sm py-4 px-6"
            required
          >
